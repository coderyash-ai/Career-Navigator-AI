...
export const getCareerRecommendations = async (
  careerRecommendationRequest: CareerRecommendationRequest,
  options?: RequestInit,
): Promise<CareerRecommendationResponse> => {
  return customFetch<CareerRecommendationResponse>(
    getGetCareerRecommendationsUrl(),
    {
      ...options,
      method: "POST",
      headers: { "Content-Type": "application/json", ...options?.headers },
      body: JSON.stringify(careerRecommendationRequest),
    },
  );
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<CareerRecommendationRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type GetCareerRecommendationsMutationBody =
  BodyType<CareerRecommendationRequest>;
...
export const getCareerRoadmap = async (
  careerRoadmapRequest: CareerRoadmapRequest,
  options?: RequestInit,
): Promise<CareerRoadmapResponse> => {
  return customFetch<CareerRoadmapResponse>(getGetCareerRoadmapUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(careerRoadmapRequest),
  });
};

export const getGetCareerRoadmapMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<CareerRoadmapRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["getCareerRoadmap"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return getCareerRoadmap(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GetCareerRoadmapMutationResult = NonNullable<
  Awaited<ReturnType<typeof getCareerRoadmap>>
>;
export type GetCareerRoadmapMutationBody = BodyType<CareerRoadmapRequest>;
export type GetCareerRoadmapMutationError = ErrorType<unknown>;

/**
 * @summary Get AI-generated learning roadmap for a career path
 */
export const useGetCareerRoadmap = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getGetCareerRoadmapMutationOptions(options));
};

/**
 * @summary Get YouTube video suggestions for a career path
 */
export const getGetYoutubeSuggestionsUrl = () => {
  return `/api/career/youtube-suggestions`;
};

export const getYoutubeSuggestions = async (
  youtubeSuggestionsRequest: YoutubeSuggestionsRequest,
  options?: RequestInit,
): Promise<YoutubeSuggestionsResponse> => {
  return customFetch<YoutubeSuggestionsResponse>(
    getGetYoutubeSuggestionsUrl(),
    {
      ...options,
      method: "POST",
      headers: { "Content-Type": "application/json", ...options?.headers },
      body: JSON.stringify(youtubeSuggestionsRequest),
    },
  );
};

export const getGetYoutubeSuggestionsMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof getYoutubeSuggestions>>,
    TError,
    { data: BodyType<YoutubeSuggestionsRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["getYoutubeSuggestions"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return getYoutubeSuggestions(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GetYoutubeSuggestionsMutationResult = NonNullable<
  Awaited<ReturnType<typeof getYoutubeSuggestions>>
>;
export type GetYoutubeSuggestionsMutationBody =
  BodyType<YoutubeSuggestionsRequest>;
export type GetYoutubeSuggestionsMutationError = ErrorType<unknown>;

/**
 * @summary Get YouTube video suggestions for a career path
 */
export const useGetYoutubeSuggestions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getGetYoutubeSuggestionsMutationOptions(options));
};
