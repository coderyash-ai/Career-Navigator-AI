        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-baseline space-x-1">
            {user ? (
              ...
              // Non-authenticated user - only show Home
              <Link href="/"
                className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${location === "/" ? "text-white bg-white/10" : "text-gray-300 hover:text-white hover:bg-white/5"}`}>
                Home
              </Link>
            )}
          </div>
          ...
          <div className="flex items-center gap-3">
            {!isLoading && (
              user ? (
                ...
                // Non-authenticated: Show Login and Register buttons
                <div className="flex items-center gap-2">
                  ...
                  <Link href="/signup">
                    <Button size="sm" className="rounded-full shadow-[0_0_15px_rgba(168,85,247,0.4)] gap-1.5">
